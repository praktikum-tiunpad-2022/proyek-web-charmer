<?php 
	...
	if(isset($_POST['add_to_cart'])) {
	   ...
	   $insert_product = mysqli_query($connect, "INSERT INTO cart (nama_brg, nama_artis, harga_brg, img_brg, qyt_brg, id_buyer, id_brg, status) VALUES('$nama_brg', '$nama_artis', '$harga_brg', '$img_brg', '$product_quantity','$id_buyer','$id_brg','1')");
                ...
                ?>
                    <div class="product-card">
                        <div class="product-image">
							...
							<form action="#" method="post">
                                <fieldset>
                                    ...
                                    <input type="hidden" name="nama_artis" value="<?php echo $data['nama_artis'];?>"/>
                                    ...
                                    <input type="submit" name="add_to_cart" value="Add to cart" onclick="return confirm('<?=$message;?>')" class="card-btn"/>
                                </fieldset>
							</form>
                        </div>
                        <div class="product-info">
                            ...
                            <span class="price">$<?=$data['harga_brg'];?></span>
                        </div>
                    </div>
                <?php
